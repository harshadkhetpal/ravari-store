...
const PRODUCTS = [
  {
    ...
    thumbnail: '/static/images/Ravari Boho-Chic Leather-Trim Tote Bag for Women - View 2.png',
    images: [
      img('/static/images/Ravari Boho-Chic Leather-Trim Tote Bag for Women - View 2.png', 'RAVARI Boho Tote Bag — Product Shot'),
  ...
  },
  {
    ...
    thumbnail: '/static/images/Ravari Leather Jewellery Box - Product Shot.jpeg',
    images: [
      img('/static/images/Ravari Leather Jewellery Box - Product Shot.jpeg', 'RAVARI Jewellery Box — Product Shot'),
      img('/static/images/Ravari Leather Jewellery Box - Dimensions.jpeg', 'RAVARI Jewellery Box — Dimensions'),
      img('/static/images/Ravari Leather Jewellery Box - Lifestyle.jpg', 'RAVARI Jewellery Box — Lifestyle'),
      img('/static/images/Ravari Leather Jewellery Box - Features.jpeg', 'RAVARI Jewellery Box — Features'),
      img('/static/images/Ravari Leather Jewellery Box - Interior View.jpeg', 'RAVARI Jewellery Box — Interior'),
    ],
  ...
  },
  {
    ...
    images: [
      ...
      img('/static/products/watch-box/12slot/img6.png', 'RAVARI Watch Box 12 Slot — View 6'),
      img('/static/products/watch-box/12slot/img7.png', 'RAVARI Watch Box 12 Slot — View 7'),
    ],
    ...
    variants: [
      {
        ...
        thumbnail: '/static/products/watch-box/12slot/img1.png',
        images: [
          img('/static/products/watch-box/12slot/img1.png', 'Watch Box 12 Slot — View 1'),
          img('/static/products/watch-box/12slot/img2.png', 'Watch Box 12 Slot — View 2'),
          img('/static/products/watch-box/12slot/img3.png', 'Watch Box 12 Slot — View 3'),
          img('/static/products/watch-box/12slot/img4.png', 'Watch Box 12 Slot — View 4'),
          img('/static/products/watch-box/12slot/img5.png', 'Watch Box 12 Slot — View 5'),
          img('/static/products/watch-box/12slot/img6.png', 'Watch Box 12 Slot — View 6'),
          img('/static/products/watch-box/12slot/img7.png', 'Watch Box 12 Slot — View 7'),
        ],
      },
      {
  ...
  },
  {
    ...
    thumbnail: '/static/images/Ravari Leather Tool Apron - View 1.png',
    images: [
      img('/static/images/Ravari Leather Tool Apron - View 1.png', 'RAVARI Work Apron — Front View'),
      img('/static/images/Ravari Leather Tool Apron - View 2.png', 'RAVARI Work Apron — Detail'),
      img('/static/images/Ravari Leather Tool Apron - View 3.png', 'RAVARI Work Apron — Pockets'),
      img('/static/images/Ravari Leather Tool Apron - View 4.png', 'RAVARI Work Apron — Lifestyle'),
      img('/static/images/Ravari Leather Tool Apron - View 5.png', 'RAVARI Work Apron — Features'),
      img('/static/images/Ravari Leather Tool Apron - View 6.png', 'RAVARI Work Apron — Strap Detail'),
    ],
  ...
  },
  {
    ...
    thumbnail: '/static/images/Ravari Premium Brown Leather Sling Bag - View 1.png',
    images: [
      img('/static/images/Ravari Premium Brown Leather Sling Bag - View 1.png', 'RAVARI Premium Sling Bag — Front'),
      img('/static/images/Ravari Premium Brown Leather Sling Bag - View 2.png', 'RAVARI Premium Sling Bag — Side'),
      img('/static/images/Ravari Premium Brown Leather Sling Bag - View 3.png', 'RAVARI Premium Sling Bag — Detail'),
      img('/static/images/Ravari Premium Brown Leather Sling Bag - View 4.png', 'RAVARI Premium Sling Bag — Interior'),
      img('/static/images/Ravari Premium Brown Leather Sling Bag - View 5.png', 'RAVARI Premium Sling Bag — Lifestyle'),
      img('/static/images/Ravari Premium Brown Leather Sling Bag - View 6.png', 'RAVARI Premium Sling Bag — Features'),
      img('/static/images/Ravari Premium Brown Leather Sling Bag - View 7.png', 'RAVARI Premium Sling Bag — Model'),
    ],
    ...
    variants: [
      {
        ...
        thumbnail: '/static/images/Ravari Premium Brown Leather Sling Bag - View 1.png',
        images: [
          img('/static/images/Ravari Premium Brown Leather Sling Bag - View 1.png', 'Premium Sling Bag — Front'),
          img('/static/images/Ravari Premium Brown Leather Sling Bag - View 2.png', 'Premium Sling Bag — Side'),
          img('/static/images/Ravari Premium Brown Leather Sling Bag - View 3.png', 'Premium Sling Bag — Detail'),
          img('/static/images/Ravari Premium Brown Leather Sling Bag - View 4.png', 'Premium Sling Bag — Interior'),
          img('/static/images/Ravari Premium Brown Leather Sling Bag - View 5.png', 'Premium Sling Bag — Lifestyle'),
          img('/static/images/Ravari Premium Brown Leather Sling Bag - View 6.png', 'Premium Sling Bag — Features'),
          img('/static/images/Ravari Premium Brown Leather Sling Bag - View 7.png', 'Premium Sling Bag — Model'),
        ],
      },
      {
        id: 'vintage', label: 'Vintage',
        price: 4599, salePrice: 2599, stock: 18,
        thumbnail: '/static/images/Ravari Vintage Brown Leather Crossbody Bag - View 1.png',
        images: [
          img('/static/images/Ravari Vintage Brown Leather Crossbody Bag - View 1.png', 'Vintage Sling Bag — Front'),
          img('/static/images/Ravari Vintage Brown Leather Crossbody Bag - View 2.png', 'Vintage Sling Bag — Side'),
          img('/static/images/Ravari Vintage Brown Leather Crossbody Bag - View 3.png', 'Vintage Sling Bag — Detail'),
          img('/static/images/Ravari Vintage Brown Leather Crossbody Bag - View 4.png', 'Vintage Sling Bag — Interior'),
          img('/static/images/Ravari Vintage Brown Leather Crossbody Bag - View 5.png', 'Vintage Sling Bag — Lifestyle'),
        ],
      },
    ],
  ...
  },
  {
    ...
    thumbnail: '/static/images/Ravari Dual-Tone Organizer Wallet - Product Shot.png',
    images: [
      img('/static/images/Ravari Dual-Tone Organizer Wallet - Product Shot.png', 'Ravari Wallet — Product Shot'),
      img('/static/images/Ravari Dual-Tone Organizer Wallet - Dimensions.png', 'Ravari Wallet — Dimensions'),
      img('/static/images/Ravari Dual-Tone Organizer Wallet - Interior View.png', 'Ravari Wallet — Interior View'),
      img('/static/images/Ravari Dual-Tone Organizer Wallet - Lifestyle.png', 'Ravari Wallet — Lifestyle'),
      img('/static/images/Ravari Dual-Tone Organizer Wallet - Model Shot.png', 'Ravari Wallet — Model Shot'),
    ],
  ...
  },
  {
    ...
    images: [
      img('/static/images/Ravari Croc-Textured Black Handbag - Product Shot.png', 'Ravari Croc Handbag — Product Shot'),
      img('/static/images/Ravari Croc-Textured Black Handbag - Dimensions.png', 'Ravari Croc Handbag — Dimensions'),
      img('/static/images/Ravari Croc-Textured Black Handbag - Features.png', 'Ravari Croc Handbag — Features'),
      img('/static/images/Ravari Croc-Textured Black Handbag - Lifestyle.png', 'Ravari Croc Handbag — Lifestyle'),
      img('/static/images/Ravari Croc-Textured Black Handbag - Model Shot.png', 'Ravari Croc Handbag — Model Shot'),
    ],
  ...
  },
  {
    ...
    thumbnail: '/static/images/Ravari Leather Key Holder Zipper Pouch - Product Shot.jpeg',
    images: [
      img('/static/images/Ravari Leather Key Holder Zipper Pouch - Product Shot.jpeg', 'RAVARI Key Holder — Product Shot'),
      img('/static/images/Ravari Leather Key Holder Zipper Pouch - Dimensions.jpeg', 'RAVARI Key Holder — Dimensions'),
      img('/static/images/Ravari Leather Key Holder Zipper Pouch - Features.jpeg', 'RAVARI Key Holder — Features'),
      img('/static/images/Ravari Leather Key Holder Zipper Pouch - Lifestyle.jpeg', 'RAVARI Key Holder — Lifestyle'),
      img('/static/images/Ravari Leather Key Holder Zipper Pouch - Car Keys Lifestyle.jpeg', 'RAVARI Key Holder — Car Keys'),
    ],
  ...
  },
  {
    ...
    thumbnail: '/static/images/Ravari Leather Desk Organizer - Product Shot.jpeg',
    images: [
  ...
  },
  {
    ...
    thumbnail: '/static/images/Ravari Premium Textured Leather Handbag - View 1.png',
    images: [
      img('/static/images/Ravari Premium Textured Leather Handbag - View 1.png', 'RAVARI Textured Handbag — Front'),
      img('/static/images/Ravari Premium Textured Leather Handbag - View 2.jpg', 'RAVARI Textured Handbag — Side'),
      img('/static/images/Ravari Premium Textured Leather Handbag - View 3.jpg', 'RAVARI Textured Handbag — Detail'),
      img('/static/images/Ravari Premium Textured Leather Handbag - View 4.png', 'RAVARI Textured Handbag — Interior'),
    ],
